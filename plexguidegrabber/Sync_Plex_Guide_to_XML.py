...
#                               CONFIGURATION
# ==============================================================================
# TIMEZONE_OFFSET: Sets the local time difference from UTC. 
#   - For Central Time (Arlington), use "-0600".
#   - If the guide is 1 hour off, change this to "-0500" or "-0700".
TIMEZONE_OFFSET = "-0600"

# PLEX_DB_PATH: The source path to your Plex EPG database file.
#   - This is where the script reads your current channel and program data.
...
# OUTPUT_XML: The final destination for your generated guide file.
#   - Point Jellyfin's XMLTV provider to this file path.
OUTPUT_XML = "/mnt/user/appdata/schedulesdirect/plex_guide.xml"

# TEMP_DIR: A temporary working folder used to copy the database.
#   - Using a copy prevents "Database is locked" errors while Plex is running.
